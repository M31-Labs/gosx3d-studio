...
func DefaultManifest() Manifest {
	return Manifest{
		...
		Capabilities: []Capability{
			...
			{ID: "asset-tools", Status: "partial", Evidence: "content addressing, byte inspection, audits, HTTP serving, live Project panel, human/native-chooser import contract, dependencies, reimport/retarget, and GLB/glTF model entities are available; external glTF dependency packaging, thumbnails, optimization, conversion, automatic file watching, and garbage collection remain pending"},
