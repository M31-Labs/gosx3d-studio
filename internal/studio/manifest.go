...
func DefaultManifest() Manifest {
	return Manifest{
		...
		Capabilities: []Capability{
			...
			{ID: "asset-tools", Status: "partial", Evidence: "content addressing, byte inspection, audits, HTTP serving, live Project panel, human/native-chooser import contract, deterministic confined external glTF dependency packaging, dependencies, reimport/retarget, and GLB/glTF model entities are available; thumbnails, optimization, conversion, automatic file watching, and garbage collection remain pending"},
		...
		NextSlice: []string{
			...
			"complete asset thumbnails, optimization, conversion, automatic file watching, and garbage collection",
