...
| Review is governed and revision-safe | Passed review checks, reasons, canonical/approval revision, fingerprint, affected IDs, and expiry are visible | Stale revisions fail; proposals are session-owned, one-shot, expiring, and one-active-per-browser |
