...
Read only these lines during the deterministic native Windows Chrome take.
Target: **2:28**. Pause naturally at each timestamp while the operator follows
[`demo-shot-list.md`](demo-shot-list.md). Say **Chrome invokes**; do not say an
agent chose the calls in this recording mode.
